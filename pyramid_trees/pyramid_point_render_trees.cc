...
void PyramidPointRenderTrees::createShaders ( void ) {
  ...
  shader_projection->vertex_source("pyramid_trees/shader_projection_trees.vert");
  shader_projection->fragment_source("pyramid_trees/shader_projection_trees.frag");
  shader_projection->install( shader_inst_debug );

  shader_analysis = new glslKernel();
  shader_analysis->vertex_source("pyramid_trees/shader_analysis_trees.vert");
  shader_analysis->fragment_source("pyramid_trees/shader_analysis_trees.frag");
  shader_analysis->install( shader_inst_debug );

  shader_copy = new glslKernel();
  shader_copy->vertex_source("pyramid_trees/shader_copy_trees.vert");  
  shader_copy->fragment_source("pyramid_trees/shader_copy_trees.frag");
