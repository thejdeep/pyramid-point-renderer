 ...
 * Default constructor.
 **/
PyramidPointRenderNearest::PyramidPointRenderNearest() : PointBasedRender(),
					   fbo_width(1800),
					   fbo_height(1200),
					   fbo_buffers_count(4),
...
PyramidPointRenderNearest::PyramidPointRenderNearest(int w, int h) : PointBasedRender(w, h),
					   fbo_width(1800),
					   fbo_height(1200),
					   fbo_buffers_count(4),
...
PyramidPointRenderNearest::~PyramidPointRenderNearest() {
...
GLuint PyramidPointRenderNearest::getTextureOfBuffer(GLuint buffer)
...
void PyramidPointRenderNearest::rasterizePixels(pixels_struct dest, pixels_struct src0, pixels_struct src1,
		     int phase)
...
pixels_struct PyramidPointRenderNearest::generatePixels(int level, 
...
void PyramidPointRenderNearest::projectSurfels ( Primitives* prim )
{
...
void PyramidPointRenderNearest::rasterizeAnalysisPyramid( void )
...
void PyramidPointRenderNearest::copyAnalysisPyramid()
...
void PyramidPointRenderNearest::rasterizeSynthesisPyramid()
     /* using ping-pong rasterization between color attachment pairs 0-2 and 1-3 */
{
  int level;
...
void PyramidPointRenderNearest::rasterizePhongShading(int bufferIndex)
     /* using ping-pong rasterization between color attachment pairs 0-2 and 1-3 */
{
  int level = 0;
  pixels_struct nullPixels;
...
/* show buffer */
void PyramidPointRenderNearest::showPixels(int bufferIndex)
{
  int level = 0;
  pixels_struct nullPixels;
  pixels_struct sourcePixels;
 ...
 **/
void PyramidPointRenderNearest::clearBuffers() {
  int i;
 ...
 **/
void PyramidPointRenderNearest::projectSamples(Primitives* prim) {
 ...
 * algorithm.
 **/
void PyramidPointRenderNearest::interpolate() {
  framebuffer_state = FBS_UNDEFINED;
 ...
 * per pixel shading.
 **/
void PyramidPointRenderNearest::draw( void ) {
 ...
 **/
void PyramidPointRenderNearest::createFBO() {
  int i;
 ...
 **/
void PyramidPointRenderNearest::createShaders ( void ) {
